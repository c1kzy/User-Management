...
type PostServiceClient interface {
	...
	ListPosts(ctx context.Context, in *Page, opts ...grpc.CallOption) (*PublicPostResponse, error)
}
...
func (c *postServiceClient) ListPosts(ctx context.Context, in *Page, opts ...grpc.CallOption) (*PublicPostResponse, error) {
...
type PostServiceServer interface {
	...
	ListPosts(context.Context, *Page) (*PublicPostResponse, error)
...
func (UnimplementedPostServiceServer) ListPosts(context.Context, *Page) (*PublicPostResponse, error) {
...
func _PostService_ListPosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).ListPosts(ctx, req.(*Page))
	}
	return interceptor(ctx, in, info, handler)
}
